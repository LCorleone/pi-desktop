...
| macOS Intel build workflow | ✅ Cross-compiles x86_64 on Apple Silicon runner (`.github/workflows/build-mac.yml`) |
| JetBrains Mono font | ✅ Default app font via appearance profiles |
